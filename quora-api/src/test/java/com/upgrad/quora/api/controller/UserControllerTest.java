...
public class UserControllerTest {
    ...
    public void signupWithRepeatedEmail() throws Exception {
        mvc.perform(MockMvcRequestBuilders.post("/user/signup?firstName=a&lastName=a&userName=non_existing_username&emailAddress=a&password=a&country=a&aboutMe=a&dob=a&contactNumber=a").contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isConflict())
